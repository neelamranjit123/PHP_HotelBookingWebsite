...
<body>
  ...
  ?>
    ...
    <h2><a href='listrooms.php'>[Return to the room listing]</a><a href='/bookaroom/'>[Return to the main page]</a></h2>
    ...
    <form method="POST" action="editroom.php">
      ...
      <p>
        ...
        <input type="text" id="description" name="description" size="50" minlength="5" maxlength="200" value="<?php echo $row['description']; ?>" required>
      </p>
      <p>
      ...
      <p>
        ...
        <input type="number" id="beds" name="beds" min="1" max="5" value=" " value="<?php echo $row['beds']; ?>" required>
      </p>
