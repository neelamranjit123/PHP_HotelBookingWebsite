...
function searchResult(searchstr) {
  ...
  xmlhttp.onreadystatechange=function() {
    ...
    //a PHP associative array
      ...
      var tbl = document.getElementById("tblcustomer"); //find the table in the HTML
...
<h2><a href='registercustomer.php'>[Create new Customer]</a><a href="/bookaroom/">[Return to the main page]</a>
</h2>
<form>
