...
<body>
  ...
  ?>
    ...
    <h2><a href='listcustomers.php'>[Return to the Customer listing]</a><a href='/bookaroom/'>[Return to the main page]</a></h2>

    <form method="POST" action="editcustomer.php">
      <input type="hidden" name="id" value="<?php echo $id; ?>">
      <p>
        <label for="fname">Name: </label>
        <input type="text" id="fname" name="fname" minlength="5" maxlength="50" required value="<?php echo $row['fname']; ?>">
      </p>
      <p>
        <label for="lname">Name: </label>
        <input type="text" id="lname" name="lname" minlength="5" maxlength="50" required value="<?php echo $row['lname']; ?>">
      </p>
      <p>
