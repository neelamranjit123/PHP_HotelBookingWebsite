...
<body>
  ...
  <h2>
    <a href="roomlisting.php">[Return to the room listing]</a>
    <a href="index.php">[Return to the main page]</a>
  </h2>

  <form class="form_settings" method="POST" action="addroom.php">
    <p>
    ...
    <p>
      ...
      <input type="text" id="description" size="50" name="description" minlength="5" maxlength="100" required>
    </p>
    <p>
